...
# marks = {"Ramesh":23, "Vivek":40, "Harsh":88, "Mohammad":60 "Jennifer":74, "Keli":90, "Debo":29, "Almond":30}
...
def group_by_marks(marks, pass_marks)
  # your code here
    marks.group_by { |key, val| (val < pass_marks ? "Failed" : "Passed")}
end

res = group_by_marks(marks, 30)
